...
__twttrlr(function (using, provide, loadrunner, define) {
        ...
        using("dom/get", "util/domready", "util/iframe", "util/layout", "util/promise", "util/querystring", "util/typevalidator", "util/util", "tfw/util/globals", function (t, n, r, i, s, o, u, a, f) {
            ...
            a.aug(g.prototype, {
                ...
                u.isArray(e) || (e = [e || document]), a.forEach(e, function (e) {
                    ...
                    var t;
                    h.byId[e.id] = e, h.list.push(e), t = e.render(c), e.rendered && (t = e.rendered()), i.push(t), t.then(function (e) {
                        var t = o(e);
                        t && twttr.events.trigger("rendered", {
                            target: t
                        })
                    })
                }), s.every.apply(null, i).then(function (e) {
                    var t = a.map(Array.prototype.slice.call(e), o);
    ...
    provide("tfw/util/tracking", function (e) {
        using("dom/cookie", "dom/delegate", "sandbox/minimal", "util/donottrack", "util/promise", "tfw/util/guest_cookie", "tfw/util/env", "util/iframe", "util/util", "$xd/json2.js", function (t, n, r, i, s, o, u, a, f) {
            function S() {
                return b ? b : b = r.createSandbox({
                    id: "rufous-sandbox"
                }, {
                    display: "none"
                }).then(f.bind(function (e) {
                    y = e, d = H(), v = B();
                    while (m[0]) A.apply(this, m.shift());
                    return g ? O() : [d, v]
                }, this))
            }
            ...
            function L(e, t, n) {
                ...
                s = f.aug({}, t, {
                    ...
                    l: I(s)
                }), j(u)) : (r = d.firstChild, r.value = +r.value || +s.dnt, o = I(s), i = y.createElement("input"), i.type = "hidden", i.name = "l", i.value = o, d.appendChild(i))
            }
            ...
            var l = "twttr_",
                ...
                }, h = ["hask", "li", "logged_in", "pid", "user_id", o.guest_id_cookie, l + "hask", l + "li", l + o.guest_id_cookie],
                p = 0,
                d, v, m = [],
                g, y, b, w = "https://twitter.com/i/jot",
    ...
    provide("tfw/util/assets", function (e) {
        using("util/env", function (t) {
            ...
            var n = {
                "embed/timeline.css": {
                    "default": "embed/timeline.633fdd7a8cbe780bedb23434c948fe33.default.css",
                    
                    "2x": "embed/timeline.633fdd7a8cbe780bedb23434c948fe33.2x.css",
                    gif: "embed/timeline.633fdd7a8cbe780bedb23434c948fe33.gif.css",
                    "default.rtl": "embed/timeline.633fdd7a8cbe780bedb23434c948fe33.default.rtl.css",
                    "2x.rtl": "embed/timeline.633fdd7a8cbe780bedb23434c948fe33.2x.rtl.css",
                    "gif.rtl": "embed/timeline.633fdd7a8cbe780bedb23434c948fe33.gif.rtl.css"
                }
            };
            e(r)
        })
    ...
    provide("tfw/widget/syndicatedbase", function (e) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "tfw/util/tracking", "dom/classname", "dom/get", "dom/delegate", "sandbox/frame", "util/env", "util/promise", "util/twitter", "util/util", function (t, n, r, i, s, o, u, a, f, l, c, h, p) {
            ...
            var d = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:focus", ".customisable:active", ".customisable-highlight:hover", ".customisable-highlight:focus", "a:hover .customisable-highlight", "a:focus .customisable-highlight"],
                v = ["a:hover .ic-mask", "a:focus .ic-mask"],
                m = [".customisable-border"],
                g = [".timeline-header h1.summary", ".timeline-header h1.summary a:link", ".timeline-header h1.summary a:visited"],
                y, b, w, E = {
                    TWEET: 0,
                    RETWEET: 10
                };
            x.prototype = new t, p.aug(x.prototype, {
                setupSandbox: function (e) {
                    this.sandbox = e, c.some(e.appendCss("body{display:none;}.var-narrow .timeline-header .follow-button, .var-narrow .timeline-header .twitter-follow-button{right:0px !important;top:9px !important;} h1.summary a{ text-indent:-1000px; overflow:hidden; display:block;background:url(http://clients.luccaco.com/unops/html/assets/imgs/@UNOPS_ORG.png) center center no-repeat; width:128px; height:18px;} .header{padding-left:0 !important;min-height:20px !important;} .u-url.profile{display:none; !important;} .u-url.permalink.customisable-highlight{float:left !important;} .dt-updated, .dt-updated .hours{text-transform:uppercase; font-family: 'lft-etica',sans-serif; font-weight:400;} .e-entry-title{font-family: 'lft-etica',sans-serif;font-size: 12px;color: #62676C;line-height: 16px;letter-spacing: 0px;} .e-entry-title a.link.customisable, .e-entry-title a.hashtag.customisable, .e-entry-title a.hashtag.customisable b{font-weight:600;} "), e.setBaseTarget("_blank"), e.appendStyleSheet(twttr.widgets.config.assetUrl() + "/" + r("embed/timeline.css"))).then(p.bind(function () {
                ...
                bindIntentHandlers: function () {
                    function r(n) {
                        var r = u.ancestor(".tweet", this, t),
                            i = p.aug({}, e.baseScribeData(), e.extractTweetScribeDetails(r));
                ...
                extractTweetScribeDetails: function (e) {
                    var t = e.getAttribute("data-tweet-id"),
            ...
            I.prototype = new n, m.aug(I.prototype, {
                ...
                create: function (e) {
                    ...
                    return this.reconfigure(e.config), this.discardStaticOverflow(i), this.sandbox.setTitle(i.getAttribute("data-iframe-title") || "Timeline"), n.retinize(i), this.constrainMedia(i), this.searchQuery = i.getAttribute("data-search-query"), this.profileId = i.getAttribute("data-profile-id"), this.timelineType = i.getAttribute("data-timeline-type"), f = this.getTweetDetails(r), m.forIn(f, function (e) {
                        ...
                        page: "timeline_" + this.timelineType,
                        component: "timeline",
                        element: "initial",
                ...
                getPreviewTimeline: function (e) {
                    u.timelinePreview({
                        success: m.bind(function (n) {
                            this.ready().then(m.bind(function () {
                                this.element = this.create(n), this.readTranslations(), this.bindInteractions(), this.updateCursors(n.headers, {
                                    initial: !0
                                }), t.doLayoutAsync(), e.fulfill(this.element)
                            }, this))
                        }, this),
                        error: function (t) {
                ...
                getTimeline: function (e) {
                    a.initPostLogging(), u.timeline(m.aug({
                        ...
                        success: m.bind(function (n) {
                            this.ready().then(m.bind(function () {
                                this.element = this.create(n), this.readTranslations(), this.bindInteractions(), this.updateTimeStamps(), this.updateCursors(n.headers, {
                                    initial: !0
                                }), n.headers.xPolling && /\d/.test(n.headers.xPolling) && (this.pollInterval = n.headers.xPolling * 1e3), this.staticTimeline || this.schedulePolling(), t.doLayoutAsync(), e.fulfill(this.sandbox.element())
                            }, this))
                        }, this),
                        error: function (t) {
                            if (!t || !t.headers) return;
    ...
    provide("tfw/widget/tweetbutton", function (e) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function (t, n, r, i, s, o) {
            ...
            l.prototype = new t, n.aug(l.prototype, {
                ...
                render: function (e, t) {
                    var r = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1384994725.html#" + this.parameters(),
                        i;
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function (t, n, r, i, s, o, u) {
            ...
            a.prototype = new n, t.aug(a.prototype, {
                ...
                render: function (e, n) {
                    ...
                    var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1384994725.html#" + this.parameters(),
